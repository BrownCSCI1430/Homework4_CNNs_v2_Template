...
\]
where $\mu_{n,c}$ and $\sigma_{n,c}^2$ are the mean and variance computed over the spatial dimensions $(H \times W)$ of image $n$, channel $c$ only. $\gamma_c$ and $\beta_c$ are learnable parameters.
